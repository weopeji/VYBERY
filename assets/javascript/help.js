        ...
        async render_body()
        {
            ...
            var _block = $(` 
                <div class="help_block">
                    <h1>Наши контакты</h1>
                    <p>В случае чего — мы обязательно поможем. По телефону, электронной почте, в соцсетях и мессенджерах. Ниже вы легко найдёте контакт, связанный с вашим вопросом</p>
